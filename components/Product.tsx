...
function Product({ product }: Props) {
    ...
    return (
        <div className='flex h-[300px] w-[100%] lg:w-[320px] select-none flex-col rounded-xl sm:h-[300px] lg:h-[400px]   md:h-[500px] md:w-[400px] cursor-pointer hover:scale-105 transition-all duration-500'>
